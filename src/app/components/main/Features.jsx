...
export default function Features() {
  ...
  return (
    <div className="relative overflow-hidden flex items-start justify-start">
      <div className="absolute top-[10%] -right-[15%] w-[500px] h-[500px] bg-[#DBE3FF] opacity-15 blur-[280px] rounded-full z-0"></div>
      <div className="absolute top-[10%] -left-[15%] w-[500px] h-[500px] bg-[#DBE3FF] opacity-15 blur-[280px] rounded-full z-0"></div>
      <Container>
        <div className="min-h-[1200px] flex flex-col justify-center">
