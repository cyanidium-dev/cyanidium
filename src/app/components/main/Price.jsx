...
export default function Price() {
    ...
    return (
      <div className="relative overflow-hidden">
        <div className="absolute top-[25%] -right-[10%] w-[500px] h-[500px] opacity-60 blur-[280px] rounded-full z-0 bg-gradient-to-r from-[#0F41FD] via-[#901090] to-[#5c0a5c] animate-gradientMove"></div>
        <Container>
                ...
                <div key={index} className="h-[368px] md:h-[430px] lg:h-[500px] p-[1px] md:flex-1 bg-[radial-gradient(ellipse_at_top_left,_#F0EEFF,_#6D65A3,_#1A1033)] rounded-lg overflow-hidden">
                  ...
                  px-7 py-10 md:px-11 md:py-12 lg:pl-[60px] lg:pt-[58px]" style={
                    ...
                    <div className="relative z-10">
                      <h3 className="mb-[14px] font-actay text-2xl md:text-[30px]lg:text-4xl uppercase" style={{ color: website.textColor }}>
                        {website.name}
                      </h3>
