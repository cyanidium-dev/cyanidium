...
export default function SuccessModal({ isOpen, onClose }) {
  ...
  const telegramChatLink = "https://t.me/FreelancerOnMondays";
        ...
        <ModalHeader className="flex flex-col gap-[18px] mb-8 py-0">
          ...
          <ModalFooter className="px-0">
              <a
                ...
                className="w-full relative py-[13.5px] font-[12px] md:font-[13px] lg:font-[14px] text-white rounded-[24px] bg-gradient-to-r from-[#080218] to-[#2462FF] flex items-center justify-center"
              >
